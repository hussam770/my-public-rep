...
public class SomeBeanTest {
  ...
  public void testAddMessage() {
	// ArgumentCaptor test whether a FacesMessage with the correct values was added to the FacesContext
    ...
    //assertNotNull(clientIdCaptor.getValue());
    ...
    assertEquals("error1", captured.getSummary());
    assertEquals("something went wrong", captured.getDetail());
  }

  @Test
  public void testLogout() {
	  //when(externalContext.getSessionId(true)).thenThrow(new Exception());
